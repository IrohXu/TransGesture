...
model.backbone = L(backbone.build_backbone_siglip)(
...
# train
train.init_checkpoint = "./output/gazefollow_siglip_base/model_final.pth"
...
# model
model.backbone.name = "./checkpoints/SigLIP/siglip-base-patch16-512"
