...
model.backbone = L(backbone.build_backbone_siglip2)(
    name="siglip2-large-patch16-512"
)
...
model.image_size = dataloader.train.input_size = dataloader.val.input_size = model.fusion.image_size = 512
...
# train
train.init_checkpoint = "./output/gesture_jointcrossfusion_siglip2_base/model_final.pth"
...
# model
model.backbone.name = "./checkpoints/SigLIP2/siglip2-large-patch16-512"
model.backbone.mm_vision_select_layer = -2
model.criterion.use_focal_loss = True
model.device = "cuda"
model.freeze_backbone = True
model.freeze_gaze_branch = True
model.patch_size = model.fusion.patch_size = 16
